...
export default function ContactsManager({ contacts, setContacts, handleFileUpload, segment, setSegment }: ContactsManagerProps) {
  return (
    <div className="form-group">
      ...
      {(!segment || segment === 'custom' || segment === 'all') && (
        <>
